...
export function t(keyPath, params = {}) {
  const fallback = typeof params === 'string' ? params : keyPath;
  const interpolationParams = params && typeof params === 'object' ? params : {};
  ...
  return value.replace(/\{(\w+)\}/g, (_, key) => {
    return interpolationParams[key] !== undefined ? interpolationParams[key] : `{${key}}`;
  });
}
